...
```
Также для проверки работы детектора используйте [ноутбук eval_vis.ipynb](https://github.com/IgorSondors/text_detector/blob/IgorSondors-README_RUS/eval_vis.ipynb) с визуализацией matplotlib
